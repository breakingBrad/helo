...
class Auth extends Component {
  ...
  register() {
    ...
    axios.post('/api/new-user', newUser)
      .then(() => {
        this.login()
    })
} else 
    ...
    return (
      <div className="auth-container">
        ...
        <div className="auth-button-container">
          <button class-name="auth-button" onClick={()=>this.login()}>Login</button>
          <button class-name="auth-button" onClick={() => this.register()}>Register</button>
        </div>
      </div>
    )
  }
